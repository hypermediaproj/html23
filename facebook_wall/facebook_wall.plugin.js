(function($) {
	$.fn.facebook_wall = function(options) {
		...
		options = $.extend({
			...
			text_labels: {
				shares: {
					singular: 'condiviso % volte',
					plural: 'condiviso % volte'
				},
				likes: {
					singular: '% mi piace',
					plural: '% mi piace'
		...
		function timeToHuman(time) {
			...
			if (time_difference < 10) {
				...
				return Math.round(time_difference) + ' secondi fa';
			} else if (Math.round(time_difference/60) === 1) {
				return Math.round(time_difference/60) + ' minuti fa';
			} else if (Math.round(time_difference/60) < 60) {
				return Math.round(time_difference/60) + ' minuti fa';
			} else if (Math.round(time_difference/(60*60)) === 1) {
				return Math.round(time_difference/(60*60)) + ' ora fa';
			} else if (Math.round(time_difference/(60*60)) < 24) {
				return Math.round(time_difference/(60*60)) + ' ore fa';
			} else if (Math.round(time_difference/(60*60*24)) === 1) {
				return Math.round(time_difference/(60*60*24)) + ' giorni fa';
